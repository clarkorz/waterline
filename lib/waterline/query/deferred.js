...
Deferred.prototype.populate = function(keyName, criteria) {
  ...
  var self = this;
  var joins = this._criteria.joins || [];
  var pk = 'id';
  var attr;
  var join;
...
/**
 * Add key selection to the criteria object
 *
 * @param {Array|Arguments} selects  select keys
 * @return this
 */
Deferred.prototype.select = function () {
  "use strict";
  this._criteria.select = _.flatten(arguments);
 ...
 * Add key selection to the criteria object
 *
 * @param {Array|Arguments} prunes  prune keys
 * @return this
 */
Deferred.prototype.prune = function () {
  "use strict";
  this._criteria.prune = _.flatten(arguments);
 ...
 * Add key selection to the criteria object
 *
 * @param {Object} fields  prune keys
 * @return this
 */
Deferred.prototype.fields = function (fields) {
  "use strict";
  this._criteria.select = _(fields).pick(function (value) { return !!value }).keys().value();
  this._criteria.prune  = _(fields).omit(function (value) { return !!value }).keys().value();

  return this;
};

/**
 * Add low level options to the criteria object
 *
 * @param {Object} options  low level options
 * @return this
 */
Deferred.prototype.options = function (options) {
  "use strict";
  this._criteria.options = options;
