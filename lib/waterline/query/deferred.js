 ...
 *
 * @param {String|Object} selects  select keys
 * @return this
 */
Deferred.prototype.select = function (selects) {
  "use strict";
  this._criteria.select = selects;
 ...
 *
 * @param {String|Object} options  low level options
 * @return this
 */
